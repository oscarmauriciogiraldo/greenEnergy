  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto bg-transparent rounded-lg">
      ...
      <div className="w-full md:w-1/2">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Distribución de Energía Hidroeléctrica</h2>
        
        <div className="space-y-4 text-gray-600">
          <p>
            <span className="font-medium text-blue-600">Energia Hidroeléctrica:</span> % del total
            <span className="block text-sm text-gray-500">(Energias en Colmbia</span>
          </p>

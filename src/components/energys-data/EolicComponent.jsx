...
const EolicComponent = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-6 max-w-6xl mx-auto bg-transparent rounded-lg">
      ...
      <div className="w-full md:w-1/2">
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            <span className="font-medium text-blue-600">Eolica:</span> % del total
            <span className="block text-sm text-gray-500">Energias en Colombia</span>
          </p>
